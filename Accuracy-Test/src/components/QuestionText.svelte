...
>
	<!-- <h2 class="text-lg sm:text-xl font-bold text-slate-700 mb-4 truncate"> -->
	<!-- 	<span class="text-indigo-600">{number}</span>. -->
	<!-- </h2> -->

	<div class="flex w-full items-center justify-between gap-3 sm:gap-4">
		<div
			class="flex h-24 flex-1 items-center justify-center rounded-md border-2 border-slate-200 bg-white p-3"
		>
			<p class="font-mono text-center text-lg text-slate-700">{text1}</p>
		</div>
		...
		<div
			class="flex h-24 flex-1 items-center justify-center rounded-md border-2 border-slate-200 bg-white p-3"
		>
			<p class="font-mono text-center text-lg text-slate-700">{text2}</p>
		</div>
	</div>
</div>
