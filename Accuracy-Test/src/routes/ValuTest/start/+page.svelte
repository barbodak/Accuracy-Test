<script lang="ts">
    ...
    const tutorialSteps = [
        {
            title: "به پرسشنامه ارزش‌های شغلی خوش آمدید",
            description:
                "این پرسشنامه به شما کمک می‌کند تا مهم‌ترین اولویت‌های شغلی خود را شناسایی کنید. در سمت راست صفحه پرسشنامه، ۲۰ کارت مختلف چیده شده که روی هرکدام توصیفی درباره اولویت‌ها و ایده‌آل‌های شغلی مشاهده خواهید‌کرد. در سمت چپ، جدولی با دقیقا ۲۰ خانه خالی در ۵ ستون تعبیه شده کارت‌ها درون آن قرار خواهند گرفت. ﺗﻮﺟﻪ داﺷﺘﻪ ﺑﺎﺷﯿﺪ که ﺑﺮای پاﺳخ‌گویی ﻣﻨﺎﺳﺐ ﺑﺎﯾﺪ با آراﻣﺶ و ﺗﻤﺮکز در ﺣﺪاﻗﻞ ۱۵ دﻗﯿﻪ وﻗﺖ این پرسشنامه را تکمیل کنید.",
        },
        {
            title: "اولویت‌بندی",
            description:
                "شما باید این ۲۰ کارت را بر روی ۲۰ خانه‌ی جدول قرار داده و چینش کارت‌ها را آن‌قدر تغییر دهید تا به ترکیب مطلوب خود برسید. در حالت مطلوب شما، کارت‌هایی که در ستون ۵ قرار می‌دهید مهمترین اولویت‌های شغلی‌تان هستند؛ کارت‌های ستون ۴ در اولویت بعدی قرار دارند؛ کارت‌های ستون ۳ از ستون‌های ۴ و ۵ کم اهمیت‌تر ولی از ستون‌های ۱ و ۲ با اهمیت‌ترند؛ و به همین ترتیب کارت‌های ستون ۲ از ستون ۱ دارای اولویت بیشتری خواهند‌بود. کارت‌هایی که در ستون ۱ قرار می‌دهید به نسبت بقیه‌ی کارت‌ها کمترین اولویت را دارند.\n\nدر چیدمان کارت‌ها به مقایسه بین آن‌ها فکر کنید. ممکن است کارتی را ابتدا در ستون ۵ قرار دهید که در انتها در ستون ۱ قرار بگیرد. ممکن است یک کارت چندین بار جابجا شود. تمرکز خود را به اهمیت کارت‌ها نسبت به هم معطوف کنید و به یاد داشته باشید گزینه‌های یک ستون همه از ارزش یکسانی برخوردار هستند.",
        },
        {
        ...
        },
        {
            ...
            description:
                "برای برگرداندن یک کارت از جدول به لیست، نشانگر خود را روی آن ببرید. یک دکمه قرمز رنگ (×) ظاهر می‌شود. روی آن کلیک کنید تا به لیست کارت‌های انتخاب نشده بازگردد.",
        },
        {
            title: " پایان پرسشنامه", // عنوان برای مطابقت با مرحله جدید به‌روز شد
            description:
                'پس از این‌که تمام ۲۰ کارت را در محل مورد‌نظر خود را در جدول قرار دادید، گزینه "پایان" در گوشه بالا سمت راست صفحه کلیک کنید تا نتایج ذخیره‌گردد.',
        },
        {
            title: "آماده‌اید؟", // مرحله نهایی
            description:
                'به یاد داشته باشید که برای تکمیل این پرسشنامه با آرامش و تمرکز حداقل ۱۵ دقیقه زمان‌ بگذارید.وقتی آماده بودید، روی دکمه "شروع پرسشنامه" کلیک کنید.',
        },
    ];
    function nextStep() {
...
<svelte:head>
    <title>راهنمای پرسشنامه ارزش‌ها</title>
</svelte:head>
        ...
        <div class="relative min-h-[350px] sm:min-h-[400px] overflow-hidden">
            {#key currentStep}
                ...
                >
                    ...
                    <p
                        class="text-base text-slate-600 dark:text-slate-300 mb-6 leading-relaxed whitespace-pre-line"
                    >
                            ...
                            {#if currentStep === 6}
                                ...
                                >
                                    ...
                                    <p class="text-sm text-center">
                                        ...
                                        و اطمینان از چینش آن‌ها روی این گزینه
                                        کلیک کنید.
                                    </p>
                                </div>
                            {/if}
...
<style>
    ...
    .mock-card-place-start {
        animation: card-select 3s ease-out infinite;
    }
    .mock-card-place-end {
        transform: scale(0);
        animation: card-appear 3s ease-in infinite;
    }
