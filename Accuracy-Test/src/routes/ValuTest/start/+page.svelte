    ...
    const tutorialSteps = [
        {
            ...
            description:
                "این پرسشنامه به شما کمک می‌کند تا مهم‌ترین اولویت‌های شغلی خود را شناسایی کنید. در سمت راست صفحه آزمون، ۲۰ کارت مختلف چیده شده که روی هرکدام توصیفی درباره اولویت‌ها و ایده‌آل‌های شغلی مشاهده خواهید‌کرد. در سمت چپ، جدولی با دقیقا ۲۰ خانه خالی در ۵ ستون تعبیه شده کارت‌ها درون آن قرار خواهند گرفت. ﺗﻮﺟﻪ داﺷﺘﻪ ﺑﺎﺷﯿﺪ که ﺑﺮای پاﺳخ‌گویی ﻣﻨﺎﺳﺐ ﺑﺎﯾﺪ با آراﻣﺶ و ﺗﻤﺮکز در ﺣﺪاﻗﻞ ۱۵ دﻗﯿﻪ وﻗﺖ این پرسشنامه را تکمیل کنید.",
        },
        {
            title: "اولویت‌بندی",
            description:
