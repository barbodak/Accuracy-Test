...
<div class="flex flex-row h-44 w-screen justify-center my-10">
	...
	<img src="src/images/{number}.jpg" class="border-4 border-black m-10 h-44" >
	{#each options as option}
		<button
			on:click={() => {selection(option)}}
			>
		<img src="src/images/{number}{option}.jpg" class=" my-10 mx-3 border-4 h-44 {selected === option? "border-blue-500": "border-greay-600"} ">
	</button>
	{/each}
</div>
